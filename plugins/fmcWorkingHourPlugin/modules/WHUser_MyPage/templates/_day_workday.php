...
<ul class="nav nav-tabs">
    ...
    <li class=""><a href="#tab2" data-toggle="tab">Entrance</a></li>
    <li class=""><a href="#tab3" data-toggle="tab">Exit</a></li>
    <li class=""><a href="#tab4" data-toggle="tab">Change Office Entrance/Exit</a></li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane" id="tab4">
        ...
        <?php $actionUrl=url_for('whuser_day_processform',array('date'=>$day['date'],'form_id'=>4)); ?>
