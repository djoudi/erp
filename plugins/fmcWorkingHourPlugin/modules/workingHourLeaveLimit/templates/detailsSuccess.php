...
<ul class="nav nav-tabs">
    <li class="<?php if (!$sf_user->getFlash("error")): ?>active<?php endif; ?>"><a href="#tab1" data-toggle="tab">Summary</a></li>
    <li class="<?php if ($sf_user->getFlash("error")): ?>active<?php endif; ?>"><a href="#tab2" data-toggle="tab">Add Limit</a></li>
    <li class=""><a href="#tab3" data-toggle="tab">Previous Additions</a></li>
</ul>
    ...
    <div class="tab-pane" id="tab3">
        ...
        <?php else: ?>
            ...
            <table class="tablesorter table table-bordered table-condensed table-hover">
                ...
                <tbody>
                    <?php foreach ($previous as $record): ?>
                        <tr>
                            <td>
