...
/**
 * LeaveRequestLimitVersion form base class.
 *
 * @method LeaveRequestLimitVersion getObject() Returns the current form's model object
 *
 * @package    fmc
 * @subpackage form
 ...
 */
abstract class BaseLeaveRequestLimitVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('leave_request_limit_version[%s]');
