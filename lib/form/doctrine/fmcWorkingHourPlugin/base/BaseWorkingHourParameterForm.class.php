...
abstract class BaseWorkingHourParameterForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'value_leavetype_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('LeaveType'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'value_leavetype_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('LeaveType'), 'required' => false)),
