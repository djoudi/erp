...
/**
 * WorkingHourQuota form base class.
 *
 * @method WorkingHourQuota getObject() Returns the current form's model object
 *
 * @package    fmc
 * @subpackage form
 ...
 */
abstract class BaseWorkingHourQuotaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('working_hour_quota[%s]');
