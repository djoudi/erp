...
abstract class BaseLeaveTypeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'will_be_paid' => new sfWidgetFormInputCheckbox(),
      'yearly_Limit' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'will_be_paid' => new sfValidatorBoolean(array('required' => false)),
      'yearly_Limit' => new sfValidatorNumber(array('required' => false)),
