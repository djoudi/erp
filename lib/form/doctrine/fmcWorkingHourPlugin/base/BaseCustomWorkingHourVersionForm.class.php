...
/**
 * CustomWorkingHourVersion form base class.
 *
 * @method CustomWorkingHourVersion getObject() Returns the current form's model object
 *
 * @package    fmc
 * @subpackage form
 ...
 */
abstract class BaseCustomWorkingHourVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('custom_working_hour_version[%s]');
