...
/**
 * CostFormInvoicingVersion filter form base class.
 *
 * @package    fmc
 * @subpackage filter
 ...
 */
abstract class BaseCostFormInvoicingVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cost_form_invoicing_version_filters[%s]');
