...
/**
 * LeaveRequestLimit filter form base class.
 *
 * @package    fmc
 * @subpackage filter
 ...
 */
abstract class BaseLeaveRequestLimitFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('leave_request_limit_filters[%s]');
