...
/**
 * WorkingHourParameter filter form base class.
 *
 * @package    fmc
 * @subpackage filter
 ...
 */
abstract class BaseWorkingHourParameterFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('working_hour_parameter_filters[%s]');
