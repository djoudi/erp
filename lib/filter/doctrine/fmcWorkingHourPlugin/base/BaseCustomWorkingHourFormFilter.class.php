...
/**
 * CustomWorkingHour filter form base class.
 *
 * @package    fmc
 * @subpackage filter
 ...
 */
abstract class BaseCustomWorkingHourFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('custom_working_hour_filters[%s]');
