...
/**
 * LeaveRequestTypeVersion filter form base class.
 *
 * @package    fmc
 * @subpackage filter
 ...
 */
abstract class BaseLeaveRequestTypeVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('leave_request_type_version_filters[%s]');
