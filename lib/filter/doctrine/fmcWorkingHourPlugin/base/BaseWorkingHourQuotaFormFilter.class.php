...
/**
 * WorkingHourQuota filter form base class.
 *
 * @package    fmc
 * @subpackage filter
 ...
 */
abstract class BaseWorkingHourQuotaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('working_hour_quota_filters[%s]');
