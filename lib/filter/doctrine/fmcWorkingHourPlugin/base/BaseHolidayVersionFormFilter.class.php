...
/**
 * HolidayVersion filter form base class.
 *
 * @package    fmc
 * @subpackage filter
 ...
 */
abstract class BaseHolidayVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('holiday_version_filters[%s]');
