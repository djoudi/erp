...
/**
 * WorkingHourQuotaVersion filter form base class.
 *
 * @package    fmc
 * @subpackage filter
 ...
 */
abstract class BaseWorkingHourQuotaVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('working_hour_quota_version_filters[%s]');
  ...
  {
    return 'WorkingHourQuotaVersion';
  }
