 ...
 * @method WorkingHourDay      setOfficeEntrance()          Sets the current record's "office_Entrance" value
 * @method WorkingHourDay      setOfficeExit()              Sets the current record's "office_Exit" value
